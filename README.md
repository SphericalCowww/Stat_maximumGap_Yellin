...
Note: given a signal distribution (should be normalize), an overall amplitude $A$ multiple to the distribution can be realize as the expected Poissonian count from the signal
