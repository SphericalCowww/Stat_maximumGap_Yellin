...
#plots
    ...
    #plot 0
    ax0.plot(nbins, uniformHist, linewidth=2,color="blue",drawstyle="steps-post");
    ...
    #plot 1
    ax1.plot(nbins, expHist, linewidth=2, color="blue", drawstyle="steps-post");
    ...
    #plot 2
    ax2.plot(nbins, gausHist, linewidth=2, color="blue", drawstyle="steps-post");
